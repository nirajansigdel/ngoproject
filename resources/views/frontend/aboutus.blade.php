    ...
    <section class="container-fluid py-5 bg-soft-blue ">
        <div class="container text-center">
            <div class="directors-header mb-5">
                <h2 class="section-title directors-title fw-bold mb-1">🌟 Board of Directors</h2>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="{{ $loop->index * 50 }}">
            <div class="director-card bg-white rounded shadow text-center">
                ...
                <div class="gradient-box text-black bg-white rounded-3 p-4 mx-auto" style="text-align: left;">
                    <h5 class="tname fw-bold mb-2">{{ $team->name }}</h5>
                    <p class="xs-text-des mb-1 text-left">Board Member / {{ $team->role }} / {{ $team->position }}</p>
    ...
    <section class="container-fluid bg-light teammember-section py-5">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title fw-bold p-0">🌟 Meet Our Team</h2>
